...
```bash
npm install -g https://github.com/fcafe/mcp-search-console/releases/download/v0.1.1/fcafe-mcp-search-console-0.1.1.tgz
```
...
- 再認証が必要な場合は、ステップ3のコマンドを再度実行してください

## アップデート

新しいバージョンがリリースされたら、同じコマンドで再インストールしてください:

```bash
npm install -g https://github.com/fcafe/mcp-search-console/releases/download/vX.X.X/fcafe-mcp-search-console-X.X.X.tgz
```
